...
public class UndoScanMutation: GraphQLMutation {
  public static let operationName: String = "UndoScan"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation UndoScan($scanId: UUID!) { undoScan(scanId: $scanId) { __typename success message ticket { __typename ...TicketFragment } alreadyScanned previousScan { __typename ...TicketScanFragment } } }"#,
  ...
  public var __variables: Variables? { ["scanId": scanId] }
  ...
  public struct Data: HorseRacingAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("undoScan", UndoScan.self, arguments: ["scanId": .variable("scanId")]),
    ] }

    public var undoScan: UndoScan { __data["undoScan"] }

    /// UndoScan
    ///
    /// Parent Type: `ScanTicketPayload`
    public struct UndoScan: HorseRacingAPI.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
