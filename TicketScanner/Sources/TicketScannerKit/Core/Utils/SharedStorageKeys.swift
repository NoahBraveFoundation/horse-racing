enum SharedStorageKey {
  static let tickets = "ticket-scanner:all-tickets:v1"
  static let scanningStats = "ticket-scanner:scanning-stats:v1"
  static let recentScans = "ticket-scanner:recent-scans:v1"
