...
export const Hero: React.FC = () => {
  return (
    <section className="relative text-white overflow-hidden min-h-[75vh]">
      ...
      />
      {/* Contrast overlays */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-noahbrave-900/40 to-black/60 mix-blend-multiply" aria-hidden="true" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center gap-6 py-20 md:py-32">
          <div>
            <h2 className="font-heading text-5xl md:text-7xl leading-none drop-shadow-md">A NIGHT</h2>
            <div className="flex items-center justify-center">
              <span className="text-2xl md:text-3xl font-light italic mr-2">at the</span>
              <span className="font-heading text-5xl md:text-7xl leading-none drop-shadow-md">RACES</span>
            </div>
          </div>

          <div className="glass rounded-xl px-6 md:px-8 py-4 inline-flex flex-col items-center gap-1">
            <div className="font-heading text-2xl md:text-3xl tracking-wide">SATURDAY, NOVEMBER 22</div>
            <div className="text-base md:text-lg">TINA'S COUNTRY HOUSE & GARDEN</div>
          </div>
