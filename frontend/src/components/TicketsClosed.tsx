...
const TicketsClosed: React.FC = () => (
  <main className="min-h-screen bg-gradient-to-b from-noahbrave-50 to-white flex items-center justify-center px-4">
    <div className="max-w-3xl w-full text-center bg-white shadow-2xl rounded-3xl p-10 md:p-14 border border-noahbrave-200">
      ...
      <p className="uppercase tracking-[0.3em] text-xs font-semibold text-noahbrave-600">Ticketing Closed</p>
      <h1 className="mt-3 font-heading text-3xl md:text-4xl text-gray-900">Thanks for a wonderful event</h1>
      <p className="mt-4 text-lg text-gray-700 leading-relaxed">
        Our 2025 event has wrapped up and ticket sales are now closed. We&rsquo;ll be back in 2026—stay tuned for updates on
        the next Night at the Races.
      </p>
