...
final class Ticket: Model, Content, @unchecked Sendable {
  ...
  init(
    id: UUID? = nil, ownerID: UUID, attendeeFirst: String, attendeeLast: String,
    seatingPreference: String? = nil, seatAssignment: String? = nil, state: TicketState = .onHold,
...
enum TicketState: String, Codable, CaseIterable, Equatable {
  case onHold = "on_hold"
